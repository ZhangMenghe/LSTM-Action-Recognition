...
TRAIN_LIST_PATH = 'list/train.list'
TEST_LIST_PATH = 'list/test.list'
PERCEPTON_TRAIN_PATH = 'bin_data/train'
PERCEPTON_TEST_PATH = 'bin_data/test/'
...
class LSTMAutoEncoder(object):
    ...
    learning_rate = 0.0025):
        ...
        self.encode_cell_unit = tf.contrib.rnn.GRUCell(n_hidden, activation = math_ops.sigmoid)
        self.decode_cell_unit = tf.contrib.rnn.GRUCell(n_hidden, activation = math_ops.sigmoid)
        self.pred_cell_unit = tf.contrib.rnn.GRUCell(n_hidden, activation = math_ops.sigmoid)
